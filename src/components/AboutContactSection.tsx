...
import { User, Briefcase, Code, Github, Linkedin, Mail } from "lucide-react";
...
const AboutContactSection = () => {
  ...
  return (
    <section id="about-contact" className="section-padding bg-gray-50 dark:bg-navy-900/30">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            About <span className="gradient-text">Me</span> & Get In <span className="gradient-text">Touch</span>
          </h2>
          <p className="text-navy-600 dark:text-gray-400 max-w-2xl mx-auto">
            Get to know more about my background and feel free to reach out for opportunities or just a friendly chat.
          </p>
        </div>
